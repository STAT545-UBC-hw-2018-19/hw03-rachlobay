...
I will now display a variation of that final graph and a table of the continent, minGDPpercap and maxGDPpercap side-by-side. I am changing the display of the bar charts of minimum and maximum GDP per capita by continent. This is because if I use the multiple graphs that I obtained using facet_wrap(~continent), they appear very small and squished when I put the table beside them.
...
Note that the animation may appear slow on Github. I was looking for options on how to get the frame speed to go faster when I use transition_reveal() but I have not been able to find a quick and easy solution.
